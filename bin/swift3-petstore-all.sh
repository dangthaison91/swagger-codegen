...
ags="$@ generate -t modules/swagger-codegen/src/main/resources/swift3/libraries/moya -i modules/swagger-codegen/src/test/resources/2_0/petstore-with-fake-endpoints-models-for-testing.yaml -l swift3-moya -c ./bin/swift3-petstore-rxswift.json -o samples/client/petstore/swift3/moya"
echo "#### Petstore Swift API client (moya + rxswift) ####"
java $JAVA_OPTS -jar $executable $ags
