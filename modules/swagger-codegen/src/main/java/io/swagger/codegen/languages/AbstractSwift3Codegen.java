...
public abstract class AbstractSwift3Codegen extends DefaultCodegen implements CodegenConfig {
    ...
    public CodegenModel reconcileProperties(CodegenModel codegenModel, CodegenModel parentCodegenModel) {
